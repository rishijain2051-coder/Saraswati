 ...
 *
 * Kept: logins, currencies, units, attributes, cost formulas, stage lines, trades,
 * holidays, workforce settings, statutory components and app settings — that is setup.
 * Gone: products, buyers, suppliers, orders, proformas, stock, workers, contractors,
 * the ledger, the board, attendance, advances, statutory postings, the change log and
 * every uploaded file. Doc sequences restart at 001.
 */
...
async function main() {
  ...
  console.log('  stage lines, trades, holidays, workforce settings, statutory components.');
}
